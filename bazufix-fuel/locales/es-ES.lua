if Config.Locale ~= 'es-ES' then return end
...
Config.Locales['es-ES'] = {
    ...
    confirm_title       = "Confirmación requerida",
    confirm_desc        = "¿Estás seguro de que quieres vender esta estación? Esta acción es irreversible.",
    btn_confirm         = "Confirmar",
    btn_cancel          = "Cancelar",
...
function T(key)
    local lang = Config.Locales[Config.Locale] or Config.Locales['es-ES']
