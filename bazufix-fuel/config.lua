--[[
    ...
    BAZUFIX FUEL V2 | Advanced System | by Bazu Store
...
-- ─────────────────────────────────────────────
Config.Locale = 'en'  -- Choose from the list above
...
Config.Settings = {
    ...
    AdminGroup        = 'admin',              -- Admin group for station management
    ...
    StockPricePerL    = 4,                    -- Wholesale fuel cost for station owner ($/litre)
}
